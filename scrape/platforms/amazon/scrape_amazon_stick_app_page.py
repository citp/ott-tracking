...
if KIDS:
    CURL_CMD = r"""curl 'https://www.amazon.com/s?i=mobile-apps&bbn=10208590011&rh=n%3A2350149011%2Cn%3A2445993011%2Cn%3A10208590011%2Cn%3A9408582011&lo=grid&dc&fst=as%3Aoff&qid=1555943617&rnid=9209898011&ref=sr_pg_1' -H 'authority: www.amazon.com' -H 'upgrade-insecure-requests: 1' -H 'user-agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/73.0.3683.103 Safari/537.36' -H 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3' -H 'accept-encoding: gzip, deflate, br' -H 'accept-language: en-US,en;q=0.9,zh-CN;q=0.8,zh;q=0.7' --compressed""" # noqa
