...
class _TlsStrategy(object):
    ...
    def __init__(self):
        ...
        self.fp = open('passthrough.log', 'a')
    ...
    def record_failure(self, server_address):
        ...
        self.log('FAIL:', server_address)
        rset.add(server_address)

    def record_skipped(self, server_address):
        self.history[server_address].append(InterceptionResult.skipped)
        self.log('SKIP:', server_address)

    def log(self, *args):
        self.fp.write(' '.join([str(v) for v in args]) + '\n')
        self.fp.flush()
...
class ConservativeStrategy(_TlsStrategy):
    ...
    def should_intercept(self, server_address):
        if rset.contains(server_address) or InterceptionResult.failure in self.history[server_address]:
            return False
        return True
